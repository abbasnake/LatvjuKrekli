...
void Martins(int _la, int _count, int _width, int _height) {
  int lineArea = _la;
  ...
  for (int i = 0; i<lines1.length; i++) {
    ...
    int y1 = height/2 - (lineHeight*3) + int(random(-lineArea, lineArea));
    int x2 = width/2 + (lineWidth*2) + int(random(-lineArea, lineArea));
  ...
  for (int i = 0; i<lines1.length; i++) {
    ...
    int y1 = height/2 - lineHeight + int(random(-lineArea, lineArea));
    int x2 = width/2 + (lineWidth*6) + int(random(-lineArea, lineArea));
    int y2 = height/2 + lineHeight + int(random(-lineArea, lineArea));
  ...
  for (int i = 0; i<lines1.length; i++) {
    int x1 = width/2 + (lineWidth*6) + int(random(-lineArea, lineArea));
    int y1 = height/2 + lineHeight + int(random(-lineArea, lineArea));
    int x2 = width/2 + (lineWidth*4) + int(random(-lineArea, lineArea));
    int y2 = height/2 + (lineHeight*3) + int(random(-lineArea, lineArea));
